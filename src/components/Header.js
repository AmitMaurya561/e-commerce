            ...
            <div className='max-w-screen-xl h-full mx-auto flex items-center justify-between'>
                ...
                duration-300'>Blog</li>
                  ...
                  <div className='relative'>
                        <img className="w-8" src={cartLogo} alt='cartLogo' />
                        <span className='absolute w-7 top-4 left-0 text-sm flex items-center justify-center'>
                            {productData.length}
                        </span>
                       </div>
                  </Link>
...
// import { useSelector } from "react-redux";
// import { Link } from "react-router-dom";
// import { cartLogo, logoDark } from "../assets/index";
...
//           <Link to="/cart">
//             <div className="relative">
//               <img className="w-6" src={cartLogo} alt="cartLogo" />
